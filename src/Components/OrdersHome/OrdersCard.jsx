...
const OrdersCard = ({
  ...
  const { bookmarkMoney, setBookmarkMoney, k } = useContext(context);
  // setY(orderSize * idMeal.substring(1, 3))
  k.push(orderSize * idMeal.substring(1, 3));
  let sum = 0;
  function as(a) {
    sum += a
    // setY(sum);
        ...
        <div className='orderCardTopInfo d-flex align-items-center'>
          ...
          <div className='orderQtywrapp d-flex align-items-center'>
            ...
            <div className='priceSize'>
              {orderSize * idMeal.substring(1, 3)}$ {y}
              {/* {setBookmarkMoney([...bookmarkMoney, (orderSize * idMeal.substring(1, 3))])} */}
              {/* {as(orderSize * idMeal.substring(1, 3))} */}
            </div>
          </div>
        </div>
